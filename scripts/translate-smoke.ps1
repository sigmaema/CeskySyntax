...
& "$transpiler" examples/smoke-current.csx generated.cpp

if ($LASTEXITCODE -ne 0) {
    throw "Translation failed with exit code $LASTEXITCODE"
}

Write-Host "Successfully translated examples/smoke-current.csx to generated.cpp"
